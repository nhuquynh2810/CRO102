...
const TextInput = (props) => {
  ...
  const [eyeIcon, setEyeIcon] = useState(require('../../assets/images/hidden_eye.png'))
  const [securePassword, setSecurePassword] = useState(true)

  const togglePasswordVisibility = () => {
    setSecurePassword(!securePassword);
    if (securePassword) {
      setEyeIcon(require('../../assets/images/eye.png'));
    } else {
      setEyeIcon(require('../../assets/images/hidden_eye.png'));
    }
  }
  return (
    <View>
